...
namespace SWE1R.Assets.Blocks.Unity.ModelBlock.Components.Nodes
{
        ...
        where T : Swe1rFlaggedNode, new()
    {
        ...
        void IFlaggedNodeWrapper.Import(Swe1rFlaggedNode source, ModelBlockItemImporter importer) =>
            Import((T)source, importer);

        Swe1rFlaggedNode IFlaggedNodeWrapper.Export(ModelBlockItemExporter exporter) =>
            Export(exporter);
